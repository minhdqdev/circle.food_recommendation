        ...
        if (!value.startsWith("+84")) {
            if (value.startsWith("0")) {
                ...
                this.setState({
                    hasError: true,
                    errorMessage:
                        "Số điện thoại phải chứa mã vùng Việt Nam +84.",
                });
            ...
            <SafeAreaView style={styles.container}>
                <View style={{ padding: 15 }}>
                    ...
                    <View style={{ marginTop: 20, marginBottom: 50 }}>
                        ...
                        >
                            <TextInput
                                ...
                                onChangeText={(value) =>
                                    this.checkValidPhoneNumber(value)
                                }
                    ...
                    <View style={{ paddingLeft: 30, paddingRight: 30 }}>
                        ...
                        <TouchableOpacity
                            style={[styles.button, styles.signInFacebookButton]}
                            onPress={() =>
                    ...
                    <View style={{ marginTop: 30 }}>
                        <Text style={{ textAlign: "center" }}>
                            Sử dụng ứng dụng là bạn đã chấp nhận
                        </Text>
                        <TouchableOpacity
                            onPress={() =>
